...
### Fixed
- A notification tone that was auditioned in the picker but never applied no longer gets written to the device: previously it stayed active and was silently persisted by the next unrelated settings change or on leaving the Config screen.
