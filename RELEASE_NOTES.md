...
- M9: a message arriving while the screen was asleep lit a blank backlight and left it glowing until the next real wake, caused by the alert tone stealing the backlight's PWM channel.
