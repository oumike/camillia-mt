...
- Replayed messages respect your ignore list, and a replay no longer disturbs the node list — a sender's Last Heard and signal readings still describe when that node was really heard, not when a router repeated it.
