...
- Heltec V4: the Notification Sound setting now appears in Web Config, so the alert beep can be turned off from the browser and not just from the device's Config screen.
