...
- Check for Updates, Update Channel, and Release Notes now sit at the very bottom of the settings list; the Cardputer still shows Release Notes without the update rows.)CAMNOTES";
