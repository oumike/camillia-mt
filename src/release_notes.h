...
- The device info screen shows the preset name (or "Custom") and now displays fractional bandwidths like 62.5 and 31.25 kHz correctly instead of rounding them to whole numbers.)CAMNOTES";
