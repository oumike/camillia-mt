...
Fixed
- Emoji and other text could silently fail to draw on busy screens when the interface ran out of working memory. The pool is much larger now - 2 MB on T-Deck, T-Lora Pager TFT, ThinkNode M9 and Mesh Deck, 768 KB on Heltec V4.)CAMNOTES";
