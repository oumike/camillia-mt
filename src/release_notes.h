...
- Turning the notification LED off mid-blink now darkens it immediately instead of leaving it stuck lit, including when the change comes from the web page or a YAML import.)CAMNOTES";
