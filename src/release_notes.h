...
- Mesh Deck: after flashing, power the board off and on - it is deliberately left halted rather than auto-reset, because a warm reset out of download mode hangs at the splash screen.)CAMNOTES";
