...
- The serial log now says when a browser hangs up mid-response and reports how long the main loop was busy, making a stalled web page diagnosable instead of silent.)CAMNOTES";
