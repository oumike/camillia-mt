...
- Web config chat showed wrapped messages back to front: a long message started with its last line and ended with its first, with the timestamp stranded in the middle. Multi-line messages sent from the device also lost their "mine" styling and were wrongly offered Reply and tapback buttons.)CAMNOTES";
